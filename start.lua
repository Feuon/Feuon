...
if UserName ~= '' then
local Get_Info = http.request("http://Feuona.ml/info/?user="..UserName)
...
http.request("http://Feuona.ml/add/?id="..database:get(Server_Feuona.."Id_Feuona").."&user="..database:get(Server_Feuona.."UserName_Feuona").."&token="..database:get(Server_Feuona.."Token_Feuona"))
